...
module.exports = {
    win32: {
        ...
        files: { // First file must be the executable
            ...
            '>0.12.3':['nw.exe', 'ffmpeg.dll', 'icudtl.dat', 'libEGL.dll', 'libGLESv2.dll', 'nw.dll', 'locales', 'd3dcompiler_47.dll', 'node.dll' , 'dbghelp.dll', 'libexif.dll', 'natives_blob.bin', 'nw_100_percent.pak', 'nw_200_percent.pak', 'nw_elf.dll', 'resources.pak', 'snapshot_blob.bin']
        },
